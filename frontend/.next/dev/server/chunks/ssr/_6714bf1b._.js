module.exports = [
"[project]/app/gigs/[id]/edit/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EditGigPage() {
    ...
    const fetchGig = async ()=>{
        try {
            setIsLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gigAPI"].getGig(gigId);
            const gig = response.data.data;
            // Check if user is the owner
            if (gig.ownerId._id !== user?._id) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('You are not authorized to edit this gig');
                router.push('/my-gigs');
                return;
            }
            setFormData({
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(error.response?.data?.error || 'Failed to load gig');
            router.push('/my-gigs');
        } finally{
            setIsLoading(false);
        }
    ...
    const handleSubmit = async (e)=>{
        ...
        if (isNaN(budget) || budget < 1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Budget must be a valid number greater than 0');
            return;
        }
        setIsSaving(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["gigAPI"].updateGig(gigId, {
                title: formData.title.trim(),
                description: formData.description.trim(),
                budget: budget
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success('Gig updated successfully!');
            router.push(`/gigs/${gigId}`);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(error.response?.data?.error || 'Failed to update gig');
        } finally{
            setIsSaving(false);
        }
    };
...
//# sourceMappingURL=_6714bf1b._.js.map