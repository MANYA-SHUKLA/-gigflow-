        ...
        if (socket) {
            const handleNotification = (data)=>{
                ...
                setNotifications((prev)=>{
                    ...
                    const exists = prev.some((n)=>n.message === newNotification.message && Math.abs(n.timestamp.getTime() - newNotification.timestamp.getTime()) < 1000);
                    if (exists) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a3d30b5a._.js.map